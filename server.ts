...
If the user asks an unrelated query, gently remind them that your specialty is demystifying the Bitcoin system and steer the focus back to Bitcoin!`;
      ...
      if (topic) {
        systemInstruction += `\nCurrently, the user is exploring the specific research paper/topic: "${topic}". Frame your responses to build off on or explain details related to this topic when helpful, but directly answer their question.`;
      }
