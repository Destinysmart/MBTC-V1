        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start justify-between gap-8 text-sm">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-4 md:flex-col md:gap-3 text-gray-500 font-medium">
              ...
              <a href="/#discover" className="hover:text-gray-900 transition-colors">Discover</a>
              <a href="/#opportunities" className="hover:text-gray-900 transition-colors">Opportunities & Jobs</a>
              ...
              <a href="https://x.com/moloBTC" target="_blank" rel="noreferrer" className="hover:text-gray-900 transition-colors inline-flex items-center gap-1.5" title="MoloBTC on X (Twitter)">
